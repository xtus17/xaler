  ...
  return (
    <div style={{ padding: "35px" }}>
      ...
      >
        ...
        <p>
          Empoderadas proporciona a los viajeros acceso rápido a detalles
        ...
        <p>
          ...
          cualquier momento Empoderadas puede interrumpir, desactivar o cancelar
          sus servicios y el acceso a los mismos. Empoderadas es una aplicación
        ...
        <h2 style={{ fontSize: "25px", fontWeight: "bold", marginTop: "45px" }}>
          Política de Privacidad
        </h2>

        <p>Última Actualización: 14 de Setiembre del 2024</p>
        <p>
          Usamos sus datos personales para proporcionar y mejorar el Servicio.
          Al usar la aplicación Empoderadas, acepta la recopilación y el uso de
          información de acuerdo con esta Política de privacidad.
        </p>
        <p>
          La aplicación de Empoderadas no recopila ni envía información de la
          ubicación de nuestros usuarios cuando la aplicación está cerrada o no
          está en uso.
        </p>
        <p>
          Si el usuario de la aplicación de Empoderadas deniega el permiso a la
          ubicación (geolocalización) limitará la experiencia de la aplicación.
        </p>
        <p>
          La aplicación de Empoderadas no revela información de nuestros
          usuarios de forma distinta a la expresada en esta política de
          privacidad.
        </p>
        ...
        <ul style={{ marginTop: "10px", lineHeight: 3 }}>
          <li>
            La publicación o propagación de contenidos que inciten a la
            violencia, la discriminación o la alteración del orden.
          </li>
          <li>
            El mal uso de la aplicación de Empoderadas para actitudes
            difamatorias, calumniosas o amenazas.
          </li>
          <li>Utilizar la aplicación de Empoderadas para fines comerciales.</li>
          <li>
